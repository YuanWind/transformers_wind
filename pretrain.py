...
from wind_modules.models.nezha.modeling_nezha import NeZhaForSequenceClassification,NeZhaForMaskedLM
...
from wind_modules.models.nezha.tokenization_nezha import NeZhaTokenizer, NeZhaTokenizerFast
...
## 加载tokenizer和模型
model_path='data_gaiic_wind/nezha'
tokenizer =  NeZhaTokenizerFast.from_pretrained(model_path, do_lower_case=True)
...
train_dataset=LineByLineTextDataset(tokenizer=tokenizer,file_path='data_gaiic_wind/train_data/unlabeled_train_data.txt',block_size=128) 

dump_pkl(train_dataset,'data_gaiic_wind/outputs/train_dataset.pkl')

train_dataset=load_pkl('data_gaiic_wind/outputs/train_dataset.pkl')
...
training_args = TrainingArguments(
    output_dir='data_gaiic_wind/outputs', 
